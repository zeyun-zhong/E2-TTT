...
MODEL_CONFIG=${1:?usage: train_1B.sh <model-config.json> <dump-folder>}
DUMP=${2:?usage: train_1B.sh <model-config.json> <dump-folder>}

export NGPU=4   # 4 x 2 x 32 = 256

TOKENIZER=fla-hub/transformer-1.3B-100B
DATASET=HuggingFaceFW/fineweb-edu
DATASET_NAME=sample-100BT
STEPS=28672   # 28672 x 256 x 2240 tokens ~= 16B (the paper calls both runs "15B")
