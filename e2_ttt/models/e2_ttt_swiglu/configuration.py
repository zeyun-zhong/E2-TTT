...
class E2TTTSwiGLUConfig(PretrainedConfig):
    """Configuration for E²-TTT_SwiGLU.

    Defaults match the released 1.3B model (``training/configs/e2_ttt_swiglu_1B.json``),
    so ``E2TTTSwiGLUConfig()`` builds a sensible model without further arguments.
