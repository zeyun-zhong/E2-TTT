...
from e2_ttt.baselines.lact.layer import LaCTSWIGLULayer
from .configuration import LaCTSWIGLUConfig
...
class LaCTPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(
        ...
        if isinstance(module, LaCTSWIGLULayer):
            ...
            logger.info("in PreTrainedModel initialize fast weights for LaCTSWIGLULayer")
            # init w0, w1, w2
...
class LaCTForCausalLM(LaCTPreTrainedModel, FLAGenerationMixin):
